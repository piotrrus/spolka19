...
import { LiningModalHelper } from './lining-modal.helper';
...
describe('LiningModalHelper', () => {
     ...
     beforeEach(() => {
          TestBed.configureTestingModule({
               ...
               declarations: [LiningModalComponent, LiningFormComponent, ConfirmDialogComponent],
               providers: [
