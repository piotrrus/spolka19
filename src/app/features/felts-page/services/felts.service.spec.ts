...
describe('FeltsService', () => {
     let service: FeltsService;
     ...
     beforeEach(() => {
          ...
          service = TestBed.inject(FeltsService);
     ...
     describe('#FeltsService', () => {
          ...
          it('should be call FeltsService getList with get method', () => {
               const url = `${environment.api}${FELTS_API_PATHS.LIST}`;
          ...
          it('should call FeltsService remove() with delete method', () => {
               const id = 2;
               const url = `${environment.api}${FELTS_API_PATHS.DELETE}${id}`;
          ...
          //OK
          it('should call FeltsService create() with post method', () => {
               const lining = feltData;
               const url = `${environment.api}${FELTS_API_PATHS.CREATE}`;
