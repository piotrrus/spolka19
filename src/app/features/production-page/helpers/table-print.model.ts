export function printTable(order: any, store: any, user: any, products: any): any {
     return {
          info: {
          ...
          header: [
               {
                    ...
                    columns: [
                         [
                              ...
                              {
                                   text: `${store?.storeAddress[0].street || '-'}, ${
                                        store?.storeAddress[0].city || '-'
                                   }, ${store?.storeAddress[0].country || '-'}`,
                              },
                         ],
                    ],
               },
               ...
               },
               {
                    columns: [
                         [
                              ...
                              {
                                   text: `${
                                        order?.address?.street || user.address[0].street || '-'
                                   }, ${order?.address?.city || user.address[0].city || '-'}, ${
                                        order?.address?.country || user.address[0].country || '-'
                                   }`,
                              },
