...
import { OrderFabricModalComponent } from './order-fabric-modal.component';

describe('OrderFabricModalComponent', () => {
     let component: OrderFabricModalComponent;
     let fixture: ComponentFixture<OrderFabricModalComponent>;

     beforeEach(() => {
          TestBed.configureTestingModule({
               declarations: [OrderFabricModalComponent, FabricFormComponent],
               imports: [
                    FormsModule,
                    ReactiveFormsModule,
                    MatFormFieldModule,
          ...
          fixture = TestBed.createComponent(OrderFabricModalComponent);
