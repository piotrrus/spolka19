...
import { ShoesModalComponent } from './shoes-modal.component';
import { MatCardModule } from '@angular/material/card';
import { MatIconModule } from '@angular/material/icon';

describe('ShoesModalComponent', () => {
     let component: ShoesModalComponent;
     let fixture: ComponentFixture<ShoesModalComponent>;

     beforeEach(() => {
          TestBed.configureTestingModule({
               declarations: [ShoesModalComponent, ShoesFormComponent],
               imports: [
                    FormsModule,
                    ReactiveFormsModule,
                    MatFormFieldModule,
          ...
          fixture = TestBed.createComponent(ShoesModalComponent);
